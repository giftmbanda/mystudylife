                ...
                <div class="col-sm-6">
                  ...
                  @if ($user->profile)
                    <div class="text-center text-left-tablet margin-bottom-1">
                      ...
                      {!! Form::model($user, array('action' => array('SoftDeletesController@update', $user->u_id), 'method' => 'PUT', 'class' => 'form-inline')) !!}
                      ...
                      {!! Form::model($user, array('action' => array('SoftDeletesController@destroy', $user->u_id), 'method' => 'DELETE', 'class' => 'form-inline', 'data-toggle' => 'tooltip', 'title' => 'Permanently Delete User')) !!}
