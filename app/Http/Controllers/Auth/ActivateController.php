...
class ActivateController extends Controller
{
    ...
    {
        $user = Auth::user();
        $lastActivation = Activation::where('user_id', $user->u_id)->get()->last();
    ...
    public function activationRequired()
    {
        ...
        if ($user->activated == false) {
            $activationsCount = Activation::where('user_id', $user->u_id)
        ...
        $data = [
            'email' => $user->email,
            'date'  => $lastActivation ? $lastActivation->created_at->format('m/d/Y') : Carbon::now()->format('m/d/Y'), //
        ];
    ...
    public function activate($token)
    {
        ...
        $allActivations = Activation::where('user_id', $user->u_id)->get();
